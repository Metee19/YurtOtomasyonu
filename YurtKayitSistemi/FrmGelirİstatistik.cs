...
namespace YurtKayitSistemi
{
    public partial class FrmGelirİstatistik : Form
    {
        ...
        private void FrmGelirİstatistik_Load(object sender, EventArgs e)
        {
            ...
            SqlCommand komut3 = new SqlCommand("select distinct(OdemeAy),Sum(OdemeMiktar) From Kasa group by OdemeAy", bgl.baglanti());
        ...
        {
            //Seçilen Aya Göre Kazancı Listeleyen Komutlar
