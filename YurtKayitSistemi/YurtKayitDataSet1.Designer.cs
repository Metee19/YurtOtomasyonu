...
namespace YurtKayitSistemi {
    ...
    public partial class YurtKayitDataSet1 : global::System.Data.DataSet {
        ...
        public partial class OgrenciDataTable : global::System.Data.TypedTableBase<OgrenciRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public OgrenciRow AddOgrenciRow(string OgrAd, string OgrSoyad, string OgrenciOdaNo) {
...
namespace YurtKayitSistemi.YurtKayitDataSet1TableAdapters {
    ...
    public partial class OgrenciTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Ogrenci] WHERE (([Ogrid] = @Original_Ogrid) AND ((@IsNull_OgrAd = 1 AND [OgrAd] IS NULL) OR ([OgrAd] = @Original_OgrAd)) AND ((@IsNull_OgrSoyad = 1 AND [OgrSoyad] IS NULL) OR ([OgrSoyad] = @Original_OgrSoyad)) AND ((@IsNull_OgrenciOdaNo = 1 AND [OgrenciOdaNo] IS NULL) OR ([OgrenciOdaNo] = @Original_OgrenciOdaNo)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Ogrenci] ([OgrAd], [OgrSoyad], [OgrenciOdaNo]) VALUES (@OgrAd," +
                " @OgrSoyad, @OgrenciOdaNo);\r\nSELECT Ogrid, OgrAd, OgrSoyad, OgrenciOdaNo FROM Og" +
                "renci WHERE (Ogrid = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Ogrenci] SET [OgrAd] = @OgrAd, [OgrSoyad] = @OgrSoyad, [OgrenciOdaNo] = @OgrenciOdaNo WHERE (([Ogrid] = @Original_Ogrid) AND ((@IsNull_OgrAd = 1 AND [OgrAd] IS NULL) OR ([OgrAd] = @Original_OgrAd)) AND ((@IsNull_OgrSoyad = 1 AND [OgrSoyad] IS NULL) OR ([OgrSoyad] = @Original_OgrSoyad)) AND ((@IsNull_OgrenciOdaNo = 1 AND [OgrenciOdaNo] IS NULL) OR ([OgrenciOdaNo] = @Original_OgrenciOdaNo)));
SELECT Ogrid, OgrAd, OgrSoyad, OgrenciOdaNo FROM Ogrenci WHERE (Ogrid = @Ogrid)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Ogrid, OgrAd, OgrSoyad, OgrenciOdaNo FROM dbo.Ogrenci";
        ...
        public virtual int Delete(int Original_Ogrid, string Original_OgrAd, string Original_OgrSoyad, string Original_OgrenciOdaNo) {
        ...
        public virtual int Insert(string OgrAd, string OgrSoyad, string OgrenciOdaNo) {
            if ((OgrAd == null)) {
        ...
        public virtual int Update(string OgrAd, string OgrSoyad, string OgrenciOdaNo, int Original_Ogrid, string Original_OgrAd, string Original_OgrSoyad, string Original_OgrenciOdaNo, int Ogrid) {
            if ((OgrAd == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string OgrAd, string OgrSoyad, string OgrenciOdaNo, int Original_Ogrid, string Original_OgrAd, string Original_OgrSoyad, string Original_OgrenciOdaNo) {
            return this.Update(OgrAd, OgrSoyad, OgrenciOdaNo, Original_Ogrid, Original_OgrAd, Original_OgrSoyad, Original_OgrenciOdaNo, Original_Ogrid);
        }
    }
