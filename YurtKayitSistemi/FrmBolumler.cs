...
namespace YurtKayitSistemi
{
    public partial class FrmBolumler : Form
    {
        ...
        private void PcbBolumEkle_Click(object sender, EventArgs e)
        {
            ...
            this.bolumlerTableAdapter.Fill(this.yurtKayitDataSet.Bolumler);//Bu komutu burada bir daha çagırdığımızda refresh görevi görüyor 
            }
            catch
            {
        ...
        {
            //Datagridde ki verilere tıklandıgı anda verileri textboxlara yazan komutlar 
            int secilen;
            string id,bolumad;
        ...
        private void PcbBolumDuzenle_Click(object sender, EventArgs e)
        {
            ...
            komut3.Parameters.AddWithValue("@p2", TxtBolumİd.Text);
